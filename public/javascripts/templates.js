...
templates['sheetinfo'] = template({"1":function(container,depth0,helpers,partials,data) {
    return "		<li>"
  ...
  return "<p>Creator: "
    + container.escapeExpression(((helper = (helper = helpers.creator || (depth0 != null ? depth0.creator : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"creator","hash":{},"data":data}) : helper)))
    + "</p>\r\n<p>Collaborators:</p>\r\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.collaborators : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
},"useData":true});
